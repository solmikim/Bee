...
public class BeesUserCount {
	...
	public int getBeesUserCount() {
		return beesUserCount;
	}

	public void setBeesUserCount(int beesUserCount) {
		this.beesUserCount = beesUserCount;
	}

	public BeesUserCount() {
		super();
		// TODO Auto-generated constructor stub
	}

	public BeesUserCount(int beesNo, String beesName, String beesCover, String beesCategory, String beesHost,
			char beesPublicYN, String beesCont, int beesUserLimit, char beesDelYN, char beesGender, int beesMaxBirth,
			int beesMinBirth, Timestamp beesDate, Timestamp beesDelDate, int beesUserCount) {
		super();
		this.beesNo = beesNo;
		this.beesName = beesName;
		this.beesCover = beesCover;
